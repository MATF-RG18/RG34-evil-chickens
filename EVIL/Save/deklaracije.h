...
int ind_Kill_player=0;// kada nas metak pogodi ovo postaje jedan i onda ne iscrtavamo igraca (ubijen je) TODO da pise da smo izgubili i da na 'R' moramo da krenemo ispocetka
