...
static void initEnemyBullets(){
 ...
 //TODO namestiti da brze ispalju metkove
  //TODO da nestanu i oni kada nestane neprijatelj koji ima metak
  if(Ind_Draw_Enemy[3]==1){
       glPushMatrix();
        
          glTranslatef(x_coor,0.6+y_t7,0);
      ...
      if(Ind_Draw_Enemy[11]==1){
        glPushMatrix();
          ...
          glTranslatef(x_coor+0.4,0.6+y_t6,0);
          glutSolidSphere(0.01, 40, 40);
      ...
      if(Ind_Draw_Enemy[25]==1){
        glPushMatrix();
          ...
          glTranslatef(x_coor+1.2,0.2+y_t5,0);
          glutSolidSphere(0.01, 40, 40);
      ...
      if(Ind_Draw_Enemy[28]==1){
        ...
        glPushMatrix();
          glTranslatef(x_coor+1.4,0+y_t4,0);
          glutSolidSphere(0.01, 40, 40);
        ...
        glPopMatrix();
         ...
         if(Ind_Draw_Enemy[15]==1){
          ...
          glPushMatrix();
           ...
           glTranslatef(x_coor+0.6,0.6+y_t3,0);
           glutSolidSphere(0.01, 40, 40);
      ...
      //...............//
           ...
           glTranslatef(x_coor+1,0.4+y_t,0);
           glutSolidSphere(0.01, 40, 40);
